module.exports = {
    ...
    UsuarioRequest: {
        ...
        properties: {
            ...
            roles_id: {
                ...
                default: 'Usuario',
                example: 'Usuario',
                description: 'Opcional. Por defecto: Usuario',
            },
            direccion: {
                type: 'string',
                maxLength: 255,
            ...
            cp: {
                ...
                example: '08001',
                pattern: '^\\d{5}$',
                description: 'Opcional. Código postal de 5 dígitos',
            },
            bloqueado: {
                type: 'integer',
                enum: [0, 1],
                default: 0,
                example: 0,
                description: 'Opcional. Por defecto: 0 (no bloqueado)',
            },
        },
    },
    UsuarioUpdateRequest: {
        type: 'object',
        minProperties: 1,
        description: 'Actualización parcial. Todos los campos son opcionales; debe enviarse al menos uno.',
        properties: {
            nombre: { type: 'string', maxLength: 45, example: 'Juan' },
            apellidos: { type: 'string', maxLength: 100, example: 'García López' },
            username: { type: 'string', maxLength: 45, example: 'juangl' },
